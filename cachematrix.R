...
#The cacheSolve function calculates the inverse of the matrix that is set by the special "matrix" of the previous function.
#However, it first checks to see if the inverse has already been calculated. If so, it gets the inverse from the cache 
#and skips the calculations. Otherwise, it calculates the inverse of the matrix and sets the value of the inverse in 
